package com.techassisto.mrinmoy.assisto.epsonPrinter;
...
public class PrinterDiscoveryActivity extends DashBoardActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrinterListAdapter = new SimpleAdapter(this, mPrinterList, R.layout.printerlistrow,
                new String[] { "PrinterName", "Target" },
                new int[] { R.id.PrinterName, R.id.Target });
        ListView list = (ListView)findViewById(R.id.listReceiveData);
    ...
    public int getLayoutResId() {
        return R.layout.activity_printer_discovery;
    }
