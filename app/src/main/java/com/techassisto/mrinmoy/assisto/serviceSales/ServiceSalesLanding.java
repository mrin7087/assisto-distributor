...
public class ServiceSalesLanding extends DashBoardActivity {
        ...
        createInvoiceBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWareHouseId == - 1) {
                    ...
                    intent.setClass(ServiceSalesLanding.this, NewSalesInvoice.class);
...
//        });
        ...
        downloadReportsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWareHouseId == - 1) {
                    ...
                    intent.putExtra("warehouseAddress", mWarehouseAddress);
                    intent.putExtra("warehouseState", mWarehouseState);
                    intent.setClass(ServiceSalesLanding.this, ServiceReportDownload.class);
                    startActivity(intent);
                }
            }
        });
    ...
    public int getLayoutResId() {
        return R.layout.activity_servicesales_landing;
    }
