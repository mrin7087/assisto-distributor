...
public class InvoiceServiceListAdapter extends ArrayAdapter<InvoiceServiceListModel> {
    ...
    private List<InvoiceServiceListModel> list;
    private final Activity context;
    private OnItemDeletedListener mDeleteListener;

    public InvoiceServiceListAdapter(Activity context, List<InvoiceServiceListModel> list) {
